    ...
    <div class=" flex flex-col ">
      ...
      <ScrollArea class="flex-1">
        <div class="flex flex-wrap gap-4  pb-4">
          <Playlist v-for="album in madeForYouAlbums" :key="album.name" :album="album" class="w-[150px]"
        ...
        <ScrollBar orientation="vertical" />
          ...
          <!-- Player & Controls -->
      <div class="py-4 px-4 bg-accent	mt-auto sticky z-40 bottom-0 flex items-center">
        <div class="w-1/4 flex items-center">
          <!-- <div class="w-1/4"> -->
            <img
              ...
              :width="56"
              :height="56"
              :class="cn('h-auto w-[60px] object-cover transition-all aspect-square')"
            />
            <div class="ml-4">
              <p class="text-white mb-2 flex flex-col font-light text-sm">
              <span>Come As You Are - Live</span>
              </p>
              <p class="text-grey-light text-xs font-light">Crowder</p>
            </div>

            <Heart class="ml-4" size="18"/>
          <!-- </div> -->
        </div>
        <div class="w-1/2 h-full flex flex-col items-center">
          <div class="w-1/3 flex justify-around items-center text-zinc-600">
            <!-- <svg class="w-4 h-4 fill-current block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <svg class="w-5 h-5 fill-current hover:text-grey-lightest block" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="block border border-solid border-gray-100 p-2 hover:text-grey-lightest rounded-full">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-play"><polygon points="6 3 20 12 6 21 6 3"/></svg>
            </span>
            <svg class="w-5 h-5 fill-current hover:text-grey-lightest block" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex w-full items-center mt-2">
            <span class="text-zinc-300 text-xs font-light">3:26</span>
            <div class="flex-1 h-1 w-full bg-zinc-300 rounded mx-4">
              <div class="bg-emerald-500 h-full rounded" style="width: 25%;"></div>
            </div>
            <span class="text-zinc-300 text-xs font-light">4:40</span>
          </div>
